...
public class MPQ {
	...
	static {
		try {
			//System.out.println("Libmpq - trying to load " + System.mapLibraryName("libmpq"));
			System.loadLibrary("libmpq");
			//System.load("libmpq.a");
		} catch (SecurityException e){
			System.out.println("Permission on Mpqlib was denied.\n" + e);
		} catch (UnsatisfiedLinkError e) {
			System.out.println("Mpqlib was not found for your platform.\n" + e);
		}
	}
	...
	public MPQ(String archive) throws Exception {
		try {
			String s = getLibraryVersion();
			System.out.println("Mpqlib-Library-Version : " + s);
		} catch (UnsatisfiedLinkError e) {
			System.out.println("Mpqlib was not loaded correctly.");
			System.exit(0);
		} 
